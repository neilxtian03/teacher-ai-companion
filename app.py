...
def get_document_qa_chain(api_key):
    ...
    - If the answer is not in the context, state "Based on the document, I cannot answer that question." or "Batay sa dokumento, hindi ko masasagot ang tanong na iyan."
